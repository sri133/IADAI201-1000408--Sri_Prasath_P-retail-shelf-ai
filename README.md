...
metrics, confusion matrix, app flow, app pipeline diagram, data processing 
pipeline, app deployment flow diagram, and web app ui ux and use sample screen shot.
